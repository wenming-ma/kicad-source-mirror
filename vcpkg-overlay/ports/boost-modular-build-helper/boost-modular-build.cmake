...
function(boost_modular_build)
    ...
    foreach(LIB IN LISTS INSTALLED_LIBS)
        ...
        string(REPLACE "-vc144-" "-vc140-" NEW_FILENAME ${NEW_FILENAME}) # To merge VS2022 17.14+ and VS2015 binaries
        string(REPLACE "-vc145-" "-vc140-" NEW_FILENAME ${NEW_FILENAME}) # To merge VS2026 and VS2015 binaries
