#!/usr/bin/env python3
"""
Copy minset files to Qt  project maintaining KiCad folder structure.
...
def copy_file_with_structure(src_file: str, kicad_root: Path, qt_project_root: Path, is_generated: bool = False, actual_build_path: Path = None):
...
def main():
    ...
    for header in categorized['regular_headers']:
        copy_file_with_structure(header, kicad_root, qt_project_root, is_generated=False, actual_build_path=actual_build_path)
    
    print("\n=== Copying regular source files ===")
    for source in categorized['regular_sources']:
        copy_file_with_structure(source, kicad_root, qt_project_root, is_generated=False, actual_build_path=actual_build_path)
    ...
    for header in categorized['generated_headers']:
        copy_file_with_structure(header, kicad_root, qt_project_root, is_generated=True, actual_build_path=actual_build_path)
    
    print("\n=== Copying generated source files ===")
    for source in categorized['generated_sources']:
        copy_file_with_structure(source, kicad_root, qt_project_root, is_generated=True, actual_build_path=actual_build_path)
