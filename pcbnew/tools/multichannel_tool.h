...
public:
    ...
    /**
     * Execute rule area generation without showing a dialog.
     * Used by the dialog to trigger generation when the button is clicked.
     */
    void ExecuteRuleAreaGeneration();
