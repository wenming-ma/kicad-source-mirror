...
private:
	...
	void OnChangeBrightness( int value ) override;

    // Event handler from QSlider: alpha (transparency) control
    void OnChangeAlpha( int value ) override;

    // Event handlers from QSpinBox
    void OnChangeEditRed( int value ) override;
    void OnChangeEditGreen( int value ) override;
    void OnChangeEditBlue( int value ) override;
    void OnChangeEditHue( int value ) override;
    void OnChangeEditSat( int value ) override;

    // mouse handlers, when clicking on a palette bitmap
	void onRGBMouseClick( QMouseEvent* event ) override;
	void onRGBMouseDrag( QMouseEvent* event ) override;
	void onHSVMouseClick( QMouseEvent* event ) override;
	void onHSVMouseDrag( QMouseEvent* event ) override;

    void onSize( QResizeEvent* event ) override;

    void OnColorValueText() override;
