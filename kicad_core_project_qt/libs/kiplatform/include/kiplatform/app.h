...
namespace KIPLATFORM
{
    namespace APP
    {
         ...
         */
        bool RegisterApplicationRestart( const QString& aCommandLine );
         ...
         */
        void SetShutdownBlockReason( QWidget* aWindow, const QString& aReason );
         ...
         */
        void RemoveShutdownBlockReason( QWidget* aWindow );
         ...
         */
        void AddDynamicLibrarySearchPath( const QString& aPath );
    }
}
