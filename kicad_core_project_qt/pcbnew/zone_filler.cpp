...
// #include <kidialog.h>  // Replaced with Qt dialogs
...
void ZONE_FILLER::SetProgressReporter( PROGRESS_REPORTER* aReporter )
{
    ...
    Q_ASSERT_X( m_commit, "ZONE_FILLER", "ZONE_FILLER must have a valid commit to call SetProgressReporter" );
}
 ...
 */
bool ZONE_FILLER::Fill( const std::vector<ZONE*>& aZones, bool aCheck, QWidget* aParent )
{
    ...
    if( aCheck )
    {
        ...
        if( outOfDate )
        {
            ...
            msgBox.setText( _( "Zone fills are out-of-date. Refill?" ) );
            msgBox.setIcon( QMessageBox::Warning );
            msgBox.setStandardButtons( QMessageBox::Ok | QMessageBox::Cancel );
            msgBox.setButtonText( QMessageBox::Ok, _( "Refill" ) );
            msgBox.setButtonText( QMessageBox::Cancel, _( "Continue without Refill" ) );
                                  ...
                                  const SHAPE_POLY_SET& aMaxExtents, SHAPE_POLY_SET& aFillPolys )
{
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In1_Cu, QStringLiteral( "smoothed-outline" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In2_Cu, QStringLiteral( "minus-thermal-reliefs" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( clearanceHoles, In3_Cu, QStringLiteral( "clearance-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( testAreas, In4_Cu, QStringLiteral( "minus-clearance-holes" ) );

    // Prune features that don't meet minimum-width criteria
    if( half_min_width - epsilon > epsilon )
    {
        testAreas.Deflate( half_min_width - epsilon, fastCornerStrategy, m_maxError );
        DUMP_POLYS_TO_COPPER_LAYER( testAreas, In5_Cu, QStringLiteral( "spoke-test-deflated" ) );

        testAreas.Inflate( half_min_width - epsilon, fastCornerStrategy, m_maxError );
        DUMP_POLYS_TO_COPPER_LAYER( testAreas, In6_Cu, QStringLiteral( "spoke-test-reinflated" ) );
    }
    ...
    DUMP_POLYS_TO_COPPER_LAYER( debugSpokes, In7_Cu, QStringLiteral( "spokes" ) );

    if( m_progressReporter && m_progressReporter->IsCancelled() )
        return false;

    aFillPolys.BooleanSubtract( clearanceHoles );
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In8_Cu, QStringLiteral( "after-spoke-trimming" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In9_Cu, QStringLiteral( "deflated" ) );
    ...
    else
    {
        ...
        DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In10_Cu, QStringLiteral( "connected-nearby-polys" ) );
    }
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In15_Cu, QStringLiteral( "after-reinflating" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In16_Cu, QStringLiteral( "after-trim-to-outline" ) );
    aFillPolys.BooleanSubtract( clearanceHoles );
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In17_Cu, QStringLiteral( "after-trim-to-clearance-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In18_Cu, QStringLiteral( "minus-higher-priority-zones" ) );
                                          ...
                                          PCB_LAYER_ID aDebugLayer, SHAPE_POLY_SET& aFillPolys )
{
    ...
    DUMP_POLYS_TO_COPPER_LAYER( holes, In10_Cu, QStringLiteral( "hatch-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( holes, In11_Cu, QStringLiteral( "fill-clipped-hatch-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( holes, In12_Cu, QStringLiteral( "outline-clipped-hatch-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( holes, In13_Cu, QStringLiteral( "pad-via-clipped-hatch-holes" ) );
    ...
    DUMP_POLYS_TO_COPPER_LAYER( aFillPolys, In14_Cu, QStringLiteral( "after-hatching" ) );
