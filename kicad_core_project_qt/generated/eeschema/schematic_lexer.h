 ...
 *    C:/Users/wenming_ma/source/repos/kicad-source-mirror/eeschema/schematic.keywords
 */
...
public:
     ...
     */
    SCHEMATIC_LEXER( const std::string& aSExpression, const QString& aSource = QString() ) :
     ...
     */
    SCHEMATIC_LEXER( FILE* aFile, const QString& aFilename ) :
