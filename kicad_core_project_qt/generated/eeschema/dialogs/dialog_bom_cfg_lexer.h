 ...
 *    C:/Users/wenming_ma/source/repos/kicad-source-mirror/eeschema/dialogs/dialog_bom_cfg.keywords
 */
...
public:
     ...
     */
    DIALOG_BOM_CFG_LEXER( const std::string& aSExpression, const QString& aSource = QString() ) :
     ...
     */
    DIALOG_BOM_CFG_LEXER( FILE* aFile, const QString& aFilename ) :
