 ...
 *    C:/Users/wenming_ma/source/repos/kicad-source-mirror/common/template_fieldnames.keywords
 */
...
public:
     ...
     */
    TEMPLATE_FIELDNAMES_LEXER( const std::string& aSExpression, const QString& aSource = QString() ) :
     ...
     */
    TEMPLATE_FIELDNAMES_LEXER( FILE* aFile, const QString& aFilename ) :
