...
public:
    ...
    // aRotation: rotation of the mouse wheel from QWheelEvent
    // Returns the scale factor to scroll by.
...
public:
    ...
    // aTimestampProv: a provider for timestamps. If null, a default will be provided using steady_clock
...
public:
    ...
    // aScale: a scaling parameter that adjusts the magnitude of the scroll. This factor
    ...
    // Multiplier for manual scale setting.
