...
public:
    ...
    {
        Q_ASSERT_X( aLayerDepth <= m_depthRange.y, "SetLayerDepth", "below minimum" );
        Q_ASSERT_X( aLayerDepth >= m_depthRange.x, "SetLayerDepth", "above maximum" );
     ...
     */
    virtual void BitmapText( const QString& aText, const VECTOR2I& aPosition,
