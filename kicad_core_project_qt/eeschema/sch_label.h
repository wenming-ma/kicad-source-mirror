...
{
public:
    SCH_LABEL_BASE( const VECTOR2I& aPos, const QString& aText, KICAD_T aType );
    ...
    static const QString GetDefaultFieldName( const QString& aName, bool aUseDefaultName );
...
{
public:
    SCH_LABEL( const VECTOR2I& aPos = VECTOR2I( 0, 0 ), const QString& aText = QString() );
    ...
    {
        return QStringLiteral( "SCH_LABEL" );
    }
...
{
public:
    SCH_HIERLABEL( const VECTOR2I& aPos = VECTOR2I( 0, 0 ), const QString& aText = QString(),
    ...
    QString GetClass() const override
    {
        return QStringLiteral( "SCH_HIERLABEL" );
    }
